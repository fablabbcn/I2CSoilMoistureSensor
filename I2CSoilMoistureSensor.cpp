...
#define i2cBegin auxWire.begin
#define i2cBeginTransmission auxWire.beginTransmission
#define i2cEndTransmission auxWire.endTransmission
#define i2cRequestFrom auxWire.requestFrom
#define i2cRead auxWire.read
#define i2cWrite auxWire.write
